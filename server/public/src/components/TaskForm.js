...
const TaskForm = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="flex justify-center items-center gap-3 border-2 rounded-3xl mt-3 pb-3" autoComplete="off">
      ...
      className="bg-[#D9C6A7] text-[#0D1732] focus:outline-none border border-gray-300 rounded py-2 px-4 block appearance-none placeholder-[#3A3B3C] h-[2.5rem] w-[12rem]"/>
      </div>
      </section>
